...
# 保存路径
OUTPUT_DIR = 'ablation\\wo_structure_loss'
...
def train_style_transfer(
    ...
    for iteration in pbar:
        ...
        alpha_c = ALPHA_C
        alpha_s = ALPHA_S
        alpha_dino = 0                          # set 0 to alpha_dino, compute total loss without dino_struct_loss 
...
if __name__ == "__main__":
    ...
    # dataset
    content_dir = "ablation\\contents"
    style_dir = "ablation\\styles"
